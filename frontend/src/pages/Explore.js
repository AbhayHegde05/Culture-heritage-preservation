...
const Explore = () => {
  ...
  const getCurrentData = () => {
    switch (activeTab) {
      case 'search':
        return { data: searchSites?.data, loading: searchLoading };
      case 'recommendations':
        return { data: recommendations?.data, loading: recommendationsLoading };
      case 'top':
        return { data: topDestinations?.data, loading: topLoading };
      case 'nearby':
        return { data: nearbySites?.data, loading: nearbyLoading };
      default:
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <section className="relative py-16 bg-gradient-to-br from-primary-600 to-accent-500 text-white">
